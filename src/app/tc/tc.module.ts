...
import { TcDaterangeComponent } from './tc-sidebar-nav/tc-daterange/tc-daterange.component';
...
@NgModule({
  declarations: [TcComponent, TcMapComponent, tcTrackPopupComponent, TsSidebarNavComponent, StormPopupComponent, TcHourRangeComponent, TcDaterangeComponent, StormSelectComponent, BufferPopupComponentComponent],
  imports: [
    CommonModule,
    HomeModule,
    MaterialModule,
